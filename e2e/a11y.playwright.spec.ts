/**
 * Accessibility tests for the Atlyn Gantt Chart.
 *
 * Coverage:
...
/* ────────────────────────────────────────────
   ...
   ──────────────────────────────────────────── */
const CONTAINER_ID = "#standard";
const DP_SELECTOR = `${CONTAINER_ID} svg.ganttChart rect.gantt-bar`;
const EXPECTED_DPS = 8;
const VISUAL_NAME = "gantt-chart";
