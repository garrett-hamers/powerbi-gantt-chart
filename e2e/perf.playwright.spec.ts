/**
 * Performance budgets — powerbi-gantt-chart.
 *
 ...
 *
 * Baseline = software-release.json. Large = many-rows.json fixture.
 */
import { test, expect } from "@playwright/test";
import * as path from "path";
import * as fs from "fs";

const REPO = "powerbi-gantt-chart";
...
const DIMS = {"width":900,"height":500};
...
const baselineDV = loadFixture("software-release.json");
const largeDV = loadFixture("many-rows.json");
